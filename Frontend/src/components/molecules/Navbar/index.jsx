...
import LogoKerchanshe from '../../../assets/images/logo/logo.webp'
...
export default function Navbar() {
    ...
    const navLinks = [
        { title: "about Us", link: "/", icon: <FaHome /> },
                        ...
                        >
                            ...
                            <div className="text-center dark:bg-boxdark">
                                <p className="text-accent dark:text-white">
                                    &copy;Copyright 2025, Mintesnot Bekele. All Rights Reserved.
                                </p>
                            </div>
                        </Drawer>
                    </div>
