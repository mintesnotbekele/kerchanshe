...
import { deleteDataPegawai, getEmployeeData, getMe } from '../../../../config/redux/action';
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(deleteDataPegawai(id)).then(() => {
                    Swal.fire({
                        title: 'Succeed',
                        text: 'Employee Data was successfully deleted.',
                        icon: 'success',
                        timer: 1000,
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Displaying {startIndex + 1}-{Math.min(endIndex, filteredDataPegawai.length)} dari {filteredDataPegawai.length} Employee Data
                        </span>
                    </div>
