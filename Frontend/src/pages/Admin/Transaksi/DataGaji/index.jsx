                    ...
                    {filteredDataGaji
                        .reduce((uniqueEntries, data) => {
                            ...
                            <h2 className="px-4 py-2 text-black dark:text-white" key={`${data.bulan}-${data.tahun}`}>
                                Displaying Employee Salary Data Monthly :
                ...
                <div className="flex justify-between items-center mt-4 flex-col md:flex-row md:justify-between">
                    <div className="flex items-center space-x-2">
                        <span className="text-gray-5 dark:text-gray-4 text-sm py-4">
                            Displaying {startIndex + 1}-{Math.min(endIndex, filteredDataGaji.length)} data {filteredDataGaji.length} Employee Salary Data
                        </span>
                    </div>
